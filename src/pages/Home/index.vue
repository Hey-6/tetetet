...
<div class="fixed-top rellax" data-rellax-speed="-2" data-rellax-xs-speed="-5" data-rellax-mobile-speed="3"
  ...
  <div class="q-pa-md q-gutter-md" style="margin-top: 300px;" :data-aos="getRandomAnimation()">
  ...
  <div class="q-pa-md" :data-aos="getRandomAnimation()">
  ...
  <q-btn color="primary" label="TEST REQUEST" style="margin-right: 30px;" @click="test2" :data-aos="getRandomAnimation()"/>
  <q-btn color="primary" label="SKIP" @click="$router.push('/Rellax')" :data-aos="getRandomAnimation()"/>
  </div>
</template>
...
import CCTV from 'cctv-everywhere'
...
onMounted(() => {
  ...
  Rellax('.rellax' as any, {
  // center: true
    callback: function (position: any) {
